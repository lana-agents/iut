...
tower arithmetic for the constructed local theory and theta data, and the variant `h312`;
conclusion `tripodTheory.StatementII`. The prime-counting bound of Proposition 1.6 is
supplied by `Iut.primeCountingBoundExplicit`.
