...
For $`\Q_2(\sqrt 2)` the construction gives
$`\mathcal O=\Z_2[\sqrt 2]`, $`e=2`, $`f=1`, and
$`\operatorname{ord}(\sqrt 2)=1/2`. Its different is generated by
$`2\sqrt 2`, equals the third power of the maximal ideal, and has normalized
order $`3/2`.
:::
