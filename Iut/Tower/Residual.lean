...
Galois-theoretic degree bounds) is proved. They are formulated for the global and admissible-prime data `(F, E, V_mod^bad, ℓ)`
...
Proposition 1.3 follows by Serre's bound), Néron–Ogg–Shafarevich, the ramification bound
away from `2·3·5·ℓ`, and the ramification of `F_tpd/F_mod` at the bad places. -/
